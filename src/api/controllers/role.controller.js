...
// export const assignRoleController = catchAsync(async (req, res) => {
//   const { userId, roleId } = req.body;
//   const userRole = await assignRoleToUser(userId, roleId, req.user.id);
//   sendSuccess(res, userRole, 'Role assigned successfully');
// });

// /**
//  * Get all available permissions (for role creation UI checkboxes)
//  */
// export const getAllPermissionsController = catchAsync(async (req, res) => {
//   const permissions = await Permission.findAll({ order: [['group', 'ASC'], ['module', 'ASC']] });
//   sendSuccess(res, permissions, 'All permissions');
// });
